...
const PriorityBadge = ({ priority }) => {
  ...
  if (priority === "High") return <span className={`${base} bg-red-100 text-red-700`}>HIGH PRIORITY</span>;
  if (priority === "Medium") return <span className={`${base} bg-yellow-100 text-yellow-700`}>MEDIUM PRIORITY</span>;
