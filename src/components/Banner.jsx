...
<div className="rounded-lg p-6 bg-gradient-to-r from-purple-500 to-violet-600 text-white shadow">
<h3 className="text-sm opacity-90">In-Progress</h3>
<div className="text-5xl font-bold mt-4">{inProgressCount}</div>
</div>


<div className="rounded-lg p-6 bg-gradient-to-r from-teal-400 to-green-600 text-white shadow">
